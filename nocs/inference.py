...
from models.model import PPFEncoder
import time
import pickle
import argparse
...
def tracking_func(input_pc,point_seg, ppf_encoder,p_args,n_pairs=100000):
    cfg             = p_args['cfg'] 
    ...
    with torch.no_grad():
        ...
        preds = ppf_encoder(pcs, pc_normals, dist, idxs=point_idxs)
    ...
    if cfg.centric == 'base':
        scale_mean = cfg.scale_mean_base
    else:
        scale_mean = cfg.scale_mean_child
